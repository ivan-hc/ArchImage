...
function _add_launcher_and_icon() {
	...
	wget -q https://dupeguru.voltaicideas.net/apple-touch-icon.png -O ./"$APP".png 2>/dev/null
...
LIBSAVED="pk p11 alsa jack pipewire pulse libQt5Core.so python libbrotlicommon.so qt $lib_browser_launcher" # Enter here keywords or file/directory names to save in /usr/lib
