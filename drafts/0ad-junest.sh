...
DEPENDENCES="alsa-lib libglvnd libpulse pipewire python mesa miniupnpc llvm llvm-libs vulkan-icd-loader" #SYNTAX: "APP1 APP2 APP3 APP4...", LEAVE BLANK IF NO OTHER DEPENDENCIES ARE NEEDED
...
LIBSAVED="libSDL libGLX libglapi libgallium libxcb libXxf libLLVM libSPIRV libsensors libxshmfence libdrm libpciaccess $lib_audio_keywords $lib_browser_launcher"
