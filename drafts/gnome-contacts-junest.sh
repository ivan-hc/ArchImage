...
LIBSAVED="libsoup libjson-glib libXcursor libprotobuf libabsl libgcrypt libtss libpsl libbrotlidec libnghttp libicudata libblkid \
libgraphite libexpat libjbig libdatrie libcurl libxmlb libyaml libsystemd libstemmer libnssutil libplds libplc libutf libkrb libk \
libcom libgpg-error libcrypto libunistring libidn libbrotlicommon libXau libXdmcp libssh libssl \
gstreamer liborc libEGL libasound libavahi-common printbackends \
libGLX libgnutls libudev libxkbcommon libwayland-cursor libgupnp-igd libgstplay libavahi-client liblcms \
libedbus-private folks $lib_audio_keywords $lib_browser_launcher"
